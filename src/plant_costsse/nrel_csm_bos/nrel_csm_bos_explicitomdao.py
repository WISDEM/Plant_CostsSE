...
class bos_csm_component(Component):
    ...
    def solve_nonlinear(self, params, unknowns, resids):
        ...
        turbine_cost = params['turbine_cost']
        
        turbine_number = params['turbine_number']
        ...
        # Outputs
        unknowns['bos_costs'] = bos.bos_costs #  = Float(iotype='out', desc='Overall wind plant balance of station/system costs up to point of comissioning')
        #bos.add_output(bos_breakdown = VarTree(BOSVarTree(), iotype='out', desc='BOS cost breakdown')
        unknowns['bos_breakdown:development_costs'] = bos.bos_breakdown_development_costs #  = Float(desc='Overall wind plant balance of station/system costs up to point of comissioning')
        unknowns['bos_breakdown:preparation_and_staging_costs'] = bos.bos_breakdown_preparation_and_staging_costs #  = Float(desc='Site preparation and staging')
        unknowns['bos_breakdown:transportation_costs'] = bos.bos_breakdown_transportation_costs #  = Float(desc='Any transportation costs to site / staging site') #BOS or turbine cost?
        unknowns['bos_breakdown:foundation_and_substructure_costs'] = bos.bos_breakdown_foundation_and_substructure_costs # Float(desc='Foundation and substructure costs')
        unknowns['bos_breakdown:electrical_costs'] = bos.bos_breakdown_electrical_costs # Float(desc='Collection system, substation, transmission and interconnect costs')
        unknowns['bos_breakdown:assembly_and_installation_costs'] = bos.bos_breakdown_assembly_and_installation_costs # Float(desc='Assembly and installation costs')
        unknowns['bos_breakdown:soft_costs'] = bos.bos_breakdown_soft_costs  # = Float(desc='Contingencies, bonds, reserves, decommissioning, profits, and construction financing costs')
        unknowns['bos_breakdown:other_costs'] = bos.bos_breakdown_other_costs # = Float(desc='Bucket for any other costs not captured above')
